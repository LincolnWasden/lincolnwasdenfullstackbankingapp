function Logout(){
  ...
  return (<>
    ...
    function goodbye(){
      ...
      return(<>
      <h5>Wanna log out? {props.user.name}?</h5>
      <button type="submit" className="btn btn-light" onClick={goodbye}>Confirm</button>
    </>);
  }
  ...
  return (
    <>
    <button type="submit" className="btn btn-light" onClick={handle}>View Your Account Info</button>
    </>
      )
    }
