function NavBar(){
  ...
  function NavLoggedIn(props){
    ...
    <a className="navbar-brand" href="#">Bad Bank - Lets Rock on</a>
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav">
        ...
        <li className="nav-item">
          <a className="nav-link" href="#/userdata/">Your Account</a>
        </li>
        <li className="nav-item">
...
function NavLoggedOut(props){
  ...
  return(
    ...
    <nav className="navbar navbar-expand-lg navbar-dark bg-primary">
      <a className="navbar-brand" href="#">Bad Bank Linc</a>
      ...
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav">
          <li className="nav-item">
            <a className="nav-link bg-dark" href="#/CreateAccount/">Create Account</a>
          </li>
        </ul>
      </div>
      <li className="nav justify-content-end">
          <a className="nav-link disabled bg-dark">Login:</a>
        </li>
      <ul className="navbar-nav">
      <input type="input" 
